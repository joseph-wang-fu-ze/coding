...
$srcFiles = @('Mpc4jRgsw.java', 'Mpc4jCapability.java', 'BlindRotateOps.java', 'LweRlweBridge.java', 'RgswPolyTest.java', 'RgswPolyDiag.java', 'BlindRotateComplete.java', 'LweToRgswOps.java') |
